            ...
            <div class="box">
                <div class="columns">
                    <div class="column is-one-thirds">
                        <p class="is-size-5 has-text-weight-bold pull-left">Ratings received</p>
                    </div>
                    <div class="column is is-one-thirds"></div>
                    <div class="column is-one-thirds">
                        <ul>
                            <li>
                            ...
                            <li>
                                ...
                                <progress class="progress is-small" value="30" max="100">15%</progress>
                            </li>
                            <li>
