              ...
              <div class="column is-two-thirds">
                ...
                <div class="box trip-info">
                    <div class="columns">
                        ...
                        <div class="column is-two-thirds">
                            <p><i class="fa fa-circle-thin"></i> {{selected.route_start_name}}</p>
                        </div>
                    </div>
                    <div class="columns">
                            <div class="column is-one-thirds">
                            ...
                            <div class="column is-two-thirds">
                                <p><i class="fa fa-circle-thin"></i> {{selected.route_end_name}}</p>
                            </div>
                        </div>
                        <div class="columns">
                                <div class="column is-one-thirds">
                                ...
                                <div class="column is-two-thirds">
                                    <p><i class="fa fa-calendar"></i> {{selected.trip_start | moment("dddd, MMMM Do YYYY") }}</p>
                                </div>
                            </div>
                            ...
                            <div v-if="selected.extra" class="box comment">
                                    <article class="media">
                                      ...
                                      <div class="media-content">
                                        <div class="content">
                                          <p>
                                            <strong>{{user.first_name}} {{user.last_name}}</strong> <small></small><small></small>
                                            <br>
                                            {{selected.extra}}
                                          </p>
                            ...
                            <div>
                                <p class="heading">
                                    ...
                                    <span v-for="pass in selected.passengers">
                                        <i v-if="pass" class="fa fa-user icon"></i>
                                        <i v-else class="fa fa-circle icon"></i>
                                    </span>
...
export default {
  ...
  computed: {
    ...
    lateAlready(){
        if(this.$moment(this.selected.trip_start).isSame(this.$moment.now(), 'day')
        && this.$moment(this.selected.trip_start).isSame(this.$moment.now(), 'month')
        && this.$moment(this.selected.trip_start).isSame(this.$moment.now(), 'year')) 
        {
            return true
        } else return false;
    }
